...
def check_permissions(permission, payload):
    ...
    if permission not in payload['permissions']:
        ...
        }, 401)     # the status code supposed to be 403 but for
# passing tests and secutity reasons I chosed 401
    return True
...
it should use the check_permissions method validate claims check the requested
permission
